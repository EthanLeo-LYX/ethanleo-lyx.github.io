...
Hi, I am Yuxuan Liu (刘宇轩)! I am currently a third year Ph.D. student at [Gaoling School of Artificial Intelligence (GSAI)](http://ai.ruc.edu.cn/) in Renmin University of China (RUC), supervised by [Prof. Rui Yan](https://scholar.google.com/citations?user=eLw6g-UAAAAJ) and [Prof. Ji-Rong Wen](https://scholar.google.com/citations?user=tbxCHJgAAAAJ). I got my B.S. degree from [College of Computer Science](https://cc.nankai.edu.cn/) in Nankai University (NKU) in 2024. I am now an intern at Hunyuan Team, Tencent.
...
- [**ICML 2026**] [Empowering Channel-of-Mobile-Experts with Informative Hybrid-Capabilities Reasoning](https://arxiv.org/abs/2602.24142).
